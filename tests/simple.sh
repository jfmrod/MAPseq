...
#./mapseq -nthreads 1 $FA data/mapseqref.fasta data/mapseqref.fasta.ncbitax > $OUT 2> /dev/null

if [ ! -f "$OUT" ]; then print "FAIL: output file missing $OUT"; exit 99; fi # output file not found
