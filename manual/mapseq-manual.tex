...

{
 ...
 {\Huge MAPseq v1.0 (October 2016)}\\[\baselineskip] % Main title which draws the focus of the reader
 {\Large \textit{bringing speed, accuracy and consistency to metagenomic ribosomal RNA analysis}}\par % Tagline or further description
}
